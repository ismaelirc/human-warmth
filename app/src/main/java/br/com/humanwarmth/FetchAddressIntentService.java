...
public class FetchAddressIntentService extends IntentService {
     ...
     */
    private void deliverResultToReceiver(int resultCode, String message, Double latitude, Double longitude) {

        Log.i(TAG, "Doação = " + latitude +" longitude"+ longitude);

        Bundle bundle = new Bundle();
        bundle.putString(Constants.RESULT_DATA_KEY, message);
        bundle.putDouble(Constants.LATITUDE_ATUAL, latitude);
        bundle.putDouble(Constants.LONGITUDE_ATUAL, longitude);
